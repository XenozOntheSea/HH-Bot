...
chalkAnimation.rainbow('\n[ VN ] • Bạn Đang Sử Dụng File Bot Leak By Võ Chí Nguyện\n[ PB ] • Leaker\n\n');
startBot();
...
const laisuat = 2
	...
	logger.loader("Chờ Chút Nha,Đang Xử lí...");
...
async function connectUptime(url, name) {
	try {
		...
		return logger('Thệ Thống Đã hoàn thành kết nối Uptime cho bạn!', '[ UPTIME ]');
	}
	catch {
		return logger('Server Uptime gặp sự cố, không thể bật uptime cho bạn! !Lỗi!', '[ UPTIME ]');
	}	
};
