    ...
    login(loginData, async(loginError, loginApiData) => {
      ...
      (async function () {
        while (true) {
          ...
          if (time == `${hour}:00:00`) {
            const res = (await axios.get("https://nguyentantairandom.nguyentantai09.repl.co/getlink1")).data.data;
            var thơ = (await axios.get("https://caochungdat.me/docs/other/thinh")).data.url;
...
(async() => {
 ...
 console.log(chalk.bold.hex("#1df027").bold("\n===================================================================\n-███╗░░██╗████████╗████████╗n- ████╗░██║╚══██╔══╝╚══██╔══╝\n- ██╔██╗██║░░░██║░░░░░░██║░░░\n-██║╚████║░░░██║░░░░░░██║░░░\n-██║░╚███║░░░██║░░░░░░██║░░░\n- ╚═╝░░╚══╝░░░╚═╝░░░░░░╚═╝░░░      * Information about me                                      ━\n━                                                                   ━\n━       * Mirai V2 - Version: 1.2.14                                ━\n━       * Bot Mod By: 𝗩𝗼̃ 𝗖𝗵𝗶́ 𝗡𝗴𝘂𝘆𝗲̣̂𝗻                                   ━\n━       * Run And Bot Management: MrBen             ━\n━       * Zalo: 0941979232                                          ━\n━       * Facebook: Hé　Lô　Nai　Tu　Nít　Du Chị　Nét　Cục Viên　Vô　Mũi　Chị　Đi                ━\n━       * Gmail: gialinh250586@gmail.com                              ━\n━                                                                   ━\n━                                                                   ━\n=====================================================================\n"));
